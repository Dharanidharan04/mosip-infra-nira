...
function installing_kernel() {
  ...
  helm -n $NS install idgenerator mosip/idgenerator --set image.repository=niradocker/kernel-idgenerator-service --set image.tag=niradev-1.2.0.1-N1 --version $CHART_VERSION
