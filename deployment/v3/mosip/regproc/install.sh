...
function installing_regproc() {
  ...
  helm -n $NS install regproc-camel mosip/regproc-camel --set image.repository=niraqa/registration-processor-common-camel-bridge --set image.tag=pre-production --version $CHART_VERSION
  ...
  helm -n $NS install regproc-group1 mosip/regproc-group1 --set image.repository=niraqa/registration-processor-stage-group-1 --set image.tag=pre-production -f group1_values.yaml --version $CHART_VERSION

  echo Installing group2
  helm -n $NS install regproc-group2 mosip/regproc-group2 --set image.repository=niraqa/registration-processor-stage-group-2 --set image.tag=pre-production  --version $CHART_VERSION

  echo Installing group3
  helm -n $NS install regproc-group3 mosip/regproc-group3 --set image.repository=niraqa/registration-processor-stage-group-3 --set image.tag=pre-production  --version $CHART_VERSION

  echo Installing group4
  helm -n $NS install regproc-group4 mosip/regproc-group4 --set image.repository=niraqa/registration-processor-stage-group-4 --set image.tag=pre-production --version $CHART_VERSION

  echo Installing group5
  helm -n $NS install regproc-group5 mosip/regproc-group5 --set image.repository=niraqa/registration-processor-stage-group-5 --set image.tag=pre-production --version $CHART_VERSION

  echo Installing group6
  helm -n $NS install regproc-group6 mosip/regproc-group6 --set image.repository=niraqa/registration-processor-stage-group-6 --set image.tag=pre-production --version $CHART_VERSION
...
echo Installing group9
  ...
  helm -n $NS install regproc-notifier mosip/regproc-notifier --set image.repository=niraqa/registration-processor-notification-service --set image.tag=pre-production --version $CHART_VERSION

  echo Installing regproc-reprocess
  helm -n $NS install regproc-reprocess mosip/regproc-reprocess --set image.repository=niraqa/registration-processor-reprocessor --set image.tag=pre-production --version $CHART_VERSION
